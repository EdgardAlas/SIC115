...
) ENGINE=InnoDB AUTO_INCREMENT=336 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- Volcando datos para la tabla sic175.configuracion: ~44 rows (aproximadamente)
...
INSERT INTO `configuracion` (`id`, `titulo`, `descripcion`, `periodo`, `cuenta`) VALUES
	...
	(314, 'clasificacion', 'activo', 23, 300),
	(315, 'clasificacion', 'pasivo', 23, 383),
	(316, 'clasificacion', 'patrimonio', 23, 450),
	(317, 'clasificacion', 'gastos', 23, 465),
	(318, 'clasificacion', 'ingresos', 23, 571),
	(319, 'cierre', 'pye', 23, 582),
	(320, 'cierre', 'iva_credito', 23, 338),
	(321, 'cierre', 'iva_debito', 23, 433),
	(322, 'cierre', 'impuesto_iva', 23, 428),
	(323, 'estado_resultados', 'ventas', 23, 573),
	(324, 'estado_resultados', 'rebajas_ventas', 23, 577),
	(325, 'estado_resultados', 'compras', 23, 467),
	(326, 'estado_resultados', 'gastos_compras', 23, 470),
	(327, 'estado_resultados', 'rebajas_compras', 23, 472),
	(328, 'estado_resultados', 'inventario', 23, 341),
	(329, 'estado_resultados', 'gastos_operacion', 23, 474),
	(330, 'estado_resultados', 'otros_productos', 23, 579),
	(331, 'estado_resultados', 'otros_gastos', 23, 568),
	(332, 'estado_resultados', 'reserva_legal', 23, 459),
	(333, 'estado_resultados', 'impuesto_renta', 23, 427),
	(334, 'estado_resultados', 'utilidad', 23, 461),
	(335, 'estado_resultados', 'perdida', 23, 461);
...
CREATE TABLE IF NOT EXISTS `cuenta` (
  ...
  KEY `fk_cuenta_periodo` (`periodo`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=591 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- Volcando datos para la tabla sic175.cuenta: ~575 rows (aproximadamente)
DELETE FROM `cuenta`;
...
-- Volcando datos para la tabla sic175.detalle_partida: ~193 rows (aproximadamente)
...
-- Volcando datos para la tabla sic175.empresa: ~7 rows (aproximadamente)
DELETE FROM `empresa`;
...
-- Volcando datos para la tabla sic175.partida: ~53 rows (aproximadamente)
DELETE FROM `partida`;
...
-- Volcando datos para la tabla sic175.periodo: ~3 rows (aproximadamente)
DELETE FROM `periodo`;
